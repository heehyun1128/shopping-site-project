window.addEventListener("load", function () {
    ...
    let location = document.querySelector(".location img")
    ...
    weatherForm.addEventListener("mouseleave", function(){
        weatherForm.style.display = "none"
    }) 
    // locationForm.innerHTML='<object type="text/html" data="home.html" ></object>'
